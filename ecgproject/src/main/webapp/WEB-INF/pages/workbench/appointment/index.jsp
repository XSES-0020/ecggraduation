            ...
            <div class="modal-body">
                ...
                <form id="createAppointmentForm" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="create-appointmentPatient" class="col-sm-2 control-label">就诊卡号<span style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-appointmentPatient">
                        </div>

                        <label for="create-appointmentDepartment" class="col-sm-2 control-label">开具科室<span style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-appointmentDepartment">
                        </div>
                    </div>
